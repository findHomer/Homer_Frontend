...
.map_wrap {position:relative;width:100vw;height:100vh;}
#category {position:absolute;top:70px;left:410px;border-radius: 5px; border:1px solid #909090;box-shadow: 0 1px 1px rgba(0, 0, 0, 0.4);background: #fff;overflow: hidden;z-index: 2;}
